...
If a particular configuration file needs to be managed by bootc, you can revert by copying the version created by the container build from `/usr/etc` to `/etc`.
